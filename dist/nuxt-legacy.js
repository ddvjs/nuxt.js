...
Options.from = function (_options) {
  ...
  if (typeof options.build.vendor !== 'undefined') {
    ...
    consola$1.warn('vendor has been deprecated due to webpack4 optimization');
  }
...
var scripts = { "build": "yarn build:nuxt && yarn build:nuxt-start && yarn build:nuxt-legacy", "build:nuxt": "cross-env NODE_ENV=production rollup -c scripts/rollup/nuxt.js", "build:nuxt-legacy": "cross-env NODE_ENV=production rollup -c scripts/rollup/nuxt-legacy.js", "build:nuxt-start": "cross-env NODE_ENV=production rollup -c scripts/rollup/nuxt-start.js", "build:make-start": "node scripts/make-start", "clean": "rimraf dist", "coverage": "codecov", "lint": "eslint --ext .js,.mjs,.vue bin lib test examples", "postinstall": "opencollective postinstall || exit 0", "prebuild": "yarn clean", "security": "nsp check || true", "test": "yarn test:fixtures && yarn test:unit", "test:fixtures": "jest --maxWorkers=4 --forceExit --coverage -e test/fixtures", "test:e2e": "jest --maxWorkers=1 --forceExit test/e2e", "test:lint": "yarn lint && yarn security", "test:unit": "jest --maxWorkers=4 --forceExit --coverage -e test/unit" };
var engines = { "node": ">=8.0.0", "npm": ">=5.0.0" };
var dependencies = { "@nuxtjs/friendly-errors-webpack-plugin": "^2.0.2", "@nuxtjs/youch": "^4.2.3", "autoprefixer": "^8.4.1", "babel-core": "^6.26.3", "babel-loader": "^7.1.4", "babel-preset-vue-app": "^2.0.0", "cache-loader": "^1.2.2", "caniuse-lite": "^1.0.30000833", "chalk": "^2.4.1", "chokidar": "^2.0.3", "compression": "^1.7.1", "connect": "^3.6.5", "consola": "^1.3.0", "css-loader": "^0.28.11", "es6-promise": "^4.2.4", "esm": "^3.0.28", "etag": "^1.8.1", "file-loader": "^1.1.11", "fresh": "^0.5.2", "fs-extra": "^6.0.0", "glob": "^7.1.2", "hash-sum": "^1.0.2", "html-minifier": "^3.5.15", "html-webpack-plugin": "^3.2.0", "launch-editor-middleware": "^2.2.1", "lodash": "^4.17.10", "lru-cache": "^4.1.2", "memory-fs": "^0.4.1", "mini-css-extract-plugin": "^0.4.0", "minimist": "^1.2.0", "opencollective": "^1.0.3", "postcss": "^6.0.22", "postcss-cssnext": "^3.1.0", "postcss-import": "^11.1.0", "postcss-import-resolver": "^1.1.0", "postcss-loader": "^2.1.4", "postcss-url": "^7.3.2", "semver": "^5.5.0", "serialize-javascript": "^1.5.0", "serve-static": "^1.13.2", "server-destroy": "^1.0.1", "std-env": "^1.3.0", "style-resources-loader": "^1.1.0", "thread-loader": "^1.1.5", "time-fix-plugin": "^2.0.1", "uglifyjs-webpack-plugin": "^1.2.5", "upath": "^1.0.5", "url-loader": "^1.0.1", "vue": "^2.5.16", "vue-loader": "^15.0.5", "vue-meta": "^1.5.0", "vue-router": "^3.0.1", "vue-server-renderer": "^2.5.16", "vue-template-compiler": "^2.5.16", "vuex": "^3.0.1", "webpack": "^4.6.0", "webpack-bundle-analyzer": "^2.11.1", "webpack-dev-middleware": "^3.1.3", "webpack-hot-middleware": "^2.22.1", "webpack-node-externals": "^1.7.2", "webpackbar": "^2.6.1" };
var devDependencies = { "babel-eslint": "^8.2.1", "babel-plugin-external-helpers": "^6.22.0", "codecov": "^3.0.1", "cross-env": "^5.1.4", "eslint": "^4.19.1", "eslint-config-standard": "^11.0.0", "eslint-config-standard-jsx": "^5.0.0", "eslint-plugin-html": "^4.0.2", "eslint-plugin-import": "^2.10.0", "eslint-plugin-jest": "^21.15.1", "eslint-plugin-node": "^6.0.0", "eslint-plugin-promise": "^3.7.0", "eslint-plugin-react": "^7.6.1", "eslint-plugin-standard": "^3.1.0", "eslint-plugin-vue": "^4.5.0", "express": "^4.16.2", "finalhandler": "^1.1.1", "get-port": "^3.2.0", "jest": "^22.4.3", "jsdom": "^11.10.0", "nsp": "^3.2.1", "pug": "^2.0.3", "pug-plain-loader": "^1.0.0", "puppeteer": "^1.2.0", "request": "^2.83.0", "request-promise-native": "^1.0.5", "rimraf": "^2.6.2", "rollup": "^0.58.1", "rollup-plugin-babel": "^3.0.4", "rollup-plugin-commonjs": "^9.1.3", "rollup-plugin-json": "^2.3.0", "rollup-plugin-node-resolve": "^3.3.0" };
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 4:
                ...
                // Log rendered url
                consola$1.debug('Rendering url ' + url);
            ...
            switch (_context6.prev = _context6.next) {
              ...
              case 9:
                ...
                if (opts.virtualConsole !== false) {
                  options.virtualConsole = new jsdom.VirtualConsole().sendTo(consola$1);
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                consola$1.debug('Call ' + name$$1 + ' hooks (' + this._hooks[name$$1].length + ')');
                _context2.prev = 3;
                _context2.next = 6;
...
var Builder = function () {
  ...
  createClass(Builder, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 21:
                ...
                consola$1.success('Builder initialized');

                consola$1.debug('App root: ' + this.options.srcDir);
      ...
      var _ref2 = asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                consola$1.debug('Generating nuxt files');
              ...
              case 15:
                ...
                // -- Routes --
                consola$1.debug('Generating routes...');
              ...
              case 43:
                ...
                consola$1.success('Nuxt files generated');
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                if (this.options.build.parallel) {
                  consola$1.info('Warming up worker pools');
                  this.perfLoader.warmupAll();
                  consola$1.success('Worker pools ready');
                }
    ...
    value: function webpackDev(compiler) {
      consola$1.debug('Adding webpack middleware...');
      ...
      var _ref = asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                consola$1.debug('Initializing generator...');
              ...
              case 3:
                ...
                consola$1.debug('Preparing routes for generate...');
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 9:
                ...
                consola$1.error('Could not resolve routes');
                throw _context3.t0;
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 3:
                ...
                consola$1.warn('SPA fallback was configured, but the configured path (' + fallbackPath + ') already exists.');
                return _context7.abrupt('return');
            ...
            switch (_context9.prev = _context9.next) {
              ...
              case 30:
                ...
                if (pageErrors.length) {
                  consola$1.error('Error generating ' + route);
                  Array.prototype.push.apply(errors, pageErrors);
                } else {
                  consola$1.success('Generated ' + route);
                }
